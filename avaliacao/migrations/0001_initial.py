    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conceitos', models.ManyToManyField(to='avaliacao.conceito', verbose_name='Conceitos do Grupo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disciplina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.disciplina', verbose_name='Disciplina')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disciplina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.disciplina', verbose_name='Disciplina')),
                ('divisao_periodo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.divisaoperiodoletivo', verbose_name='Divisão do Período')),
                ('turma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.turma', verbose_name='Turma')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conteudos', to='avaliacao.diarioonline', verbose_name='Diário')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_lancamento', models.DateTimeField(auto_now_add=True, verbose_name='Data do Lançamento')),
                ('aluno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='alunos.aluno', verbose_name='Aluno')),
                ('conceito', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='avaliacao.conceito', verbose_name='Conceito')),
                ('disciplina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.disciplina', verbose_name='Disciplina')),
                ('divisao_periodo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.divisaoperiodoletivo', verbose_name='Divisão do Período')),
                ('habilidade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.habilidadecompetencia', verbose_name='Habilidade/Competência')),
                ('usuario_lancamento', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Usuário que Lançou')),
                ('turma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.turma', verbose_name='Turma')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_lancamento', models.DateTimeField(auto_now_add=True, verbose_name='Data do Lançamento')),
                ('aluno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='alunos.aluno', verbose_name='Aluno')),
                ('conceito_global', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='avaliacao.conceito', verbose_name='Conceito Global')),
                ('usuario_lancamento', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Usuário que Lançou')),
                ('turma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.turma', verbose_name='Turma')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_lancamento', models.DateTimeField(auto_now_add=True, verbose_name='Data do Lançamento')),
                ('aluno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='alunos.aluno', verbose_name='Aluno')),
                ('conceito', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='avaliacao.conceito', verbose_name='Conceito')),
                ('disciplina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.disciplina', verbose_name='Disciplina')),
                ('divisao_periodo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.divisaoperiodoletivo', verbose_name='Divisão do Período')),
                ('usuario_lancamento', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Usuário que Lançou')),
                ('turma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.turma', verbose_name='Turma')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aluno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='alunos.aluno', verbose_name='Aluno')),
                ('usuario_lancamento', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Usuário que Lançou')),
                ('disciplina', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='avaliacao.disciplina', verbose_name='Disciplina')),
                ('divisao_periodo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.divisaoperiodoletivo', verbose_name='Divisão do Período')),
                ('turma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.turma', verbose_name='Turma')),
            ],
            options={
