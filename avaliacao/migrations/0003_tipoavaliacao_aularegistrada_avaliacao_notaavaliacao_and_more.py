...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('alunos', '0001_initial'),
        ('avaliacao', '0002_alter_turma_options_turma_data_criacao_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('turma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aulas', to='avaliacao.turma', verbose_name='Turma')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Professor')),
                ('turma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='avaliacoes', to='avaliacao.turma', verbose_name='Turma')),
                ('tipo_avaliacao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avaliacao.tipoavaliacao', verbose_name='Tipo de Avaliação')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avaliacao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notas', to='avaliacao.avaliacao', verbose_name='Avaliação')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_registro', models.DateTimeField(auto_now_add=True, verbose_name='Data do Registro')),
                ('aluno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='alunos.aluno', verbose_name='Aluno')),
                ('aula', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='frequencias', to='avaliacao.aularegistrada', verbose_name='Aula')),
